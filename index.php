...
body {
    ...
    margin: 20px;
    background-color:rgb(170, 234, 250);
}
h1 {
    text-align: center;
    color: #333;
...
th {
    background-color:rgb(242, 13, 192);
    color: white;
}
tr:nth-child(even) {
    background-color:rgb(12, 241, 62);
}
tr:hover {
...
.boton-mapa:hover {
    background-color:rgb(213, 241, 32);
}
</style>
</head>
<body>
...
<!-- Botón bien posicionado y estilizado -->
